...
class TransactionExecuter {
    constructor(connection, usingBundle, transactions, priorityFee, jitoFee, jitoFeePayer, jitoBlockEngine) {
        ...
        this.jitoFee = jitoFee ? jitoFee : 0.0005;
        this.status = ExectuerStatus.EXE_STATUS_NONE;
        this.error = undefined;
    ...
    executeBundle() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield (0, bundle_1.createAndSendBundle)(this.connection, this.transactions, this.jitoFeepair, this.jitoBlockEngine, this.jitoFee);
